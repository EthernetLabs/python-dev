...
sys.path.insert(0, '/home/ahmer/Ahmer/Techknox/Python_Exercises/IoT-Gateway-V2/')
from serial_config_in import ser_init_in
...
##        ser_obj_in = ser_init_in()
##        ser_in = ser_obj_in.serial_init()
##        print "SER = "
##        print ser_in
##        
        write = serial_get(self.ser_in)
        write.serial_write(payl)
