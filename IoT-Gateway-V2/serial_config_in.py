...
class ser_init_in():
        ...
        def serial_init(self):
                _section = 'SERIAL'
                _device = self.parse.getSectionOption(_section, 'devicein')
                ...
                try:
                        ser_init_in.ser = serial.Serial (port = _device, baudrate = _baudrate, timeout = _timeout, \
